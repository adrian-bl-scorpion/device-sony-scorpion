...
TARGET_PREBUILT_KERNEL := $(LOCAL_PATH)/sgp611-kernel
TARGET_PREBUILT_DT     := $(LOCAL_PATH)/sgp611-dt.img

PRODUCT_COPY_FILES += $(TARGET_PREBUILT_KERNEL):kernel
PRODUCT_COPY_FILES += $(TARGET_PREBUILT_DT):dt.img
...
PRODUCT_BRAND := Sony
PRODUCT_MODEL := Xperia Z3 Tablet Compact WIFI (pabx / AOSP)
